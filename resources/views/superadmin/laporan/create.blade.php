...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark"><i class="fas fa-file-alt me-2"></i>Tambah Laporan Penjualan</h2>
                    ...
                    <form action="{{ route('superadmin.laporan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_pesanan') is-invalid @enderror" 
                                   id="total_pesanan" name="total_pesanan" value="{{ old('total_pesanan') }}" 
                                   min="0" required>
                            @error('total_pesanan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_penjualan') is-invalid @enderror" 
                                   id="total_penjualan" name="total_penjualan" value="{{ old('total_penjualan') }}" 
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('superadmin.laporan.index') }}" class="btn btn-secondary">Batal</a>
