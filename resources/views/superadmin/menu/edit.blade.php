...
<form action="{{ route('superadmin.menu.update', $menu->menu_id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <a href="{{ route('superadmin.menu.index') }}" class="btn btn-secondary">Batal</a>
</form>
@endsection
