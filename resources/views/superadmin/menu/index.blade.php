...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Daftar Menu</h2>
    <a href="{{ route('superadmin.menu.create') }}" class="btn btn-success"><i class="fa-solid fa-plus"></i> Tambah Menu</a>
</div>

<div class="card mb-3">
    <div class="card-body">
        <form method="GET" action="{{ route('superadmin.menu.index') }}">
            <div class="row g-3 align-items-end">
                ...
                {{-- Tombol Reset --}}
                <div class="col-md-2">
                    <a href="{{ route('superadmin.menu.index') }}" class="btn btn-secondary w-100">
                        Reset
                    </a>
                </div>
...
@endif
            ...
            <td>
                <a href="{{ route('superadmin.menu.edit', $menu->menu_id) }}" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                <form action="{{ route('superadmin.menu.destroy', $menu->menu_id) }}" method="POST" style="display:inline-block;">
                    @csrf
                    @method('DELETE')
