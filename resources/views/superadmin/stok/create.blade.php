...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark"><i class="fas fa-box me-2"></i>Tambah Stok</h2>
        <a href="{{ route('superadmin.stok.index') }}" class="btn btn-secondary">
                    ...
                    <form action="{{ route('superadmin.stok.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('jumlah_stok') is-invalid @enderror" 
                                   id="jumlah_stok" name="jumlah_stok" value="{{ old('jumlah_stok') }}" 
                                   min="0" required>
                            @error('jumlah_stok')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Jika menu sudah memiliki stok, jumlah akan ditambahkan</small>
                        </div>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('superadmin.stok.index') }}" class="btn btn-secondary">Batal</a>
